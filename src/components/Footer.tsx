    ...
    <footer className="bg-slate-800 text-slate-300 py-12">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="mb-6 max-w-2xl mx-auto">
          ...
          I’d love to chat and discuss how we can take your mindset and performance to the next level. Click below to schedule a free consultation or reach out for more information.
        </p>
        ...
        <div className="flex justify-center space-x-6 mb-6">
          ...
          <a href="mailto:coachcsmentalgains@gmail.com" className="hover:text-white transition-colors">
            <Mail size={28} />
            <span className="sr-only">Email</span>
          </a>
        </div>
        <p className="text-sm text-slate-400">
          Contact: coachcsmentalgains@gmail.com
        </p>
        <p className="text-sm text-slate-400 mt-2">
          &copy; {new Date().getFullYear()} Coach C’s Mental Gains (CCMG). All rights reserved.
